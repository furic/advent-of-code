...
To save Christmas, the Elves need **you** to _finish decorating the North Pole by December 12th_.
...
Because the dial is a circle, turning the dial _left from `0` one click makes it point at `99`. Similarly, turning the dial _right from `99` one click makes it point at `0`.
